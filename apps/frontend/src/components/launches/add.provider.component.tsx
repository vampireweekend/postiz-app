    ...
    <div className="flex flex-col gap-[16px] pt-[8px]">
      <p className="text-[14px] text-textColor/80">
        {t(
          ...
          'The DiscoPost browser extension is not installed. You need to install it before connecting this channel.'
        )}
      </p>
  ...
  return (
    <div className="flex flex-col gap-[16px] pt-[8px]">
      ...
      <ul className="flex flex-col gap-[8px] list-disc ps-[20px] text-[14px] text-textColor/80">
        ...
        <li>
          DiscoPost does not take responsibility for any issues arising or account termination due to the use of this method.
        </li>
      </ul>
          ...
          try {
            ...
            toaster.show(
              t(
                ...
                'DiscoPost browser extension is not installed or not reachable.'
              ),
              'warning'
            );
            return;
