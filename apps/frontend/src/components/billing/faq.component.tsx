  ...
  return [
      ...
      ? [
          {
            title: t(
              ...
              'Am I going to be charged by DiscoPost?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_postiz_will_hold',
              'To confirm credit card information DiscoPost will hold $2 and release it immediately, you can cancel your subscription anytime from settings without talking to a person'
            ),
          },
        ]
      : []),
    {
      title: t(
        ...
        'Can I trust DiscoPost?'
      ),
      description: t(
        'faq_postiz_gitroom_is_proudly_open_source',
        'DiscoPost is proudly open-source! We believe in an ethical and transparent culture, meaning that DiscoPost will live forever. You can check out the entire code or use it for personal projects. To view the open-source repository, <a href="https://github.com/gitroomhq/postiz-app" target="_blank" style="text-decoration: underline;">click here</a>.'
      ),
    },
    {
      ...
      description: t(
        ...
        `DiscoPost allows you to schedule your posts between different channels.
